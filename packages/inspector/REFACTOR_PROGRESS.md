...
- **Worktree:** `/tmp/inspector-agent-a`
- **Session ID:** `agent-a-v2`
- **Status:** 🟡 Running
- **Tasks:**
...
- **Worktree:** `/tmp/inspector-agent-b`
- **Session ID:** `agent-b-v2`
- **Status:** 🟡 Running
- **Tasks:**
...
- **Worktree:** `/tmp/inspector-agent-c`
- **Session ID:** `agent-c-v2`
- **Status:** 🟡 Running
- **Tasks:**
