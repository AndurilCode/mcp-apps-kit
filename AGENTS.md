<!-- This file mirrors CLAUDE.md for OpenAI Codex compatibility -->
<!-- See CLAUDE.md for the canonical instructions -->
...
- **50% test coverage** - CI fails below this. Tests mirror source in `tests/`
